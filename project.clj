(defproject jv-clock "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "jv-clock.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main jv-clock.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "jv-clock.core/on-figwheel-reload"}

                :compiler {:main jv-clock.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/jv_clock.js"
